    ...
    return (
        <div className="py-24 sm:py-32">
            <div className="flex flex-col items-center justify-center mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div className="mt-10 grid max-w-lg grid-cols-3 items-center gap-x-12 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                    <Image
