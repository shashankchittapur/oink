...
export default function AboutUsMainSection() {
    ...
    return (
        <div className="lg:container flex flex-col">
            <div className="flex flex-col items-center justify-center space-y-20 lg:pt-24 lg:pb-24">
                <div className="text-center lg:w-3/4 ">
                    <h1 className="lg:text-9xl text-3xl font-bold tracking-tight sm:text-3xl bg-gradient-to-r from-cyan-400 to-pink-600 bg-clip-text text-transparent">
                        We love creators
                    </h1>
                    <h2 className="mt-6 lg:text-lg text-md  leading-8 dark:text-gray-400 text-gray-800">
                        We are a team of passionate people whose goal is to improve everyone&apos;s life through disruptive products. We build great products to solve your business problems.
                    </h2>
                </div>

                <div className="flex flex-1 ">
                    <div className="flex flex-1 lg:flex-row flex-col lg:space-x-10 space-y-5 dark:text-gray-400 ">
                ...
                <div className="lg:flex lg:flex-row grid grid-cols-2 gap-y-5  w-full">
